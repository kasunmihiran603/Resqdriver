...
export const PaymentBilling = () => {
  ...
  const rawFee = outstandingRequest
              ...
              {outstandingRequest ? (
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  <div className="space-y-2">
                    ...
                    <h3 className="text-xl font-bold text-foreground">{outstandingRequest.fee}</h3>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {savedCards.map((card) => (
                      <div
                        ...
                        className={`p-4 rounded-xl border cursor-pointer transition-all flex flex-col justify-between h-28 relative overflow-hidden ${
            ...
            <CardContent className="p-5 space-y-4">
              <div className="space-y-2 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-emerald-500">-${discount.toFixed(2)}</span>
                </div>
        ...
        <div className="text-center py-6 flex flex-col items-center justify-center space-y-4">
          ...
          <div className="bg-muted/40 p-4 rounded-xl border border-border/60 w-full text-left space-y-2 max-w-sm">
            ...
            <div className="flex justify-between text-xs">
              ...
              <span className="font-bold text-foreground">{outstandingRequest?.fee}</span>
            </div>
          </div>
