      ...
      <Card>
        ...
        <CardContent className="divide-y divide-border/60">
          <ToggleRow
            ...
            desc="In-app alerts for platform events and system updates"
            checked={notifications.push}
            onChange={() => toggleNotif("push")}
          />
          <ToggleRow
            label="Email Notifications"
            desc="Email updates for critical platform activity and reports"
            checked={notifications.email}
            onChange={() => toggleNotif("email")}
          />
          <ToggleRow
            label="SMS Alerts"
            desc="Text message alerts for high-priority system events"
        ...
        <CardContent className="space-y-3">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-rose-500/5 border border-rose-500/20 rounded-xl">
            ...
            <Button
              ...
              className="shrink-0 border-rose-500/40 text-rose-600 hover:bg-rose-500/10 hover:border-rose-500/60"
            >
